...
class ModelingProcessing(object):
    ...
    def model(self):
        ...
        self.rf = RandomForestClassifier(
            criterion='entropy', max_features='sqrt', n_estimators=100, n_jobs=-1)
    ...
    def print_info_on_confusion_matrix(self):
        ...
        # Calculate metrics for PRECISION, RECALL, SPECIFICITY and FP_RATE for each transport method
        accuracy_model = (TP_bike + TP_bus + TP_car +
                          TP_walk)/float(Total_instances)
...
if __name__ == "__main__":
    ...
    # Extract transport mode from data
    ...
    # Print info on confusion matrix
